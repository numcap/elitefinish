		...
		<>
			...
			<div className='flex justify-center items-center'>
				<div className='flex flex-col justify-center items-center mt-10 sm:w-1/2 sm:px-0 px-10 xl:w-1/3 gap-10 text-xl'>
					...
					<p>
						This will be a great fit if you are looking to keep the maintenance
						of your vehicle looking great. This can range anywhere from weekly,
						bi-weekly, or even monthly, it just depends on how often you use
						your vehicle.
					</p>
					<p>
