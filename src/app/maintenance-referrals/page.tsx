		...
		<div className='flex justify-center items-center'>
			<div className='flex flex-col justify-center items-center mt-10 sm:w-1/2 sm:px-0 px-10 xl:w-1/3 gap-10 text-xl'>
				...
				<p>
					...
					Showroom Shine and our Quick Cabin Care.
				</p>
				<p className='text-2xl text-center font-semibold -mb-5'>
				...
				<p>
					...
					stains, spills, or even pet hair then I highly recommend to go with
					our Full Interior Cleaning then we can be able to maintenance the
					vehicle to keep it in a great condition.
				</p>
				<p className='text-2xl text-center font-semibold -mb-5'>
				...
				<p>
					...
					through a series of our Showroom Shine + Ceramic Sealant services
					applied to be able to maintain that protection. <br />
					<br />
					For the interior, it will have to go through our Full Cabin Care
