				...
				<div className='relative flex flex-col h-[40rem]'>
					...
					<div className='relative z-10 flex flex-col items-center justify-center h-full gap-20'>
						...
						<h1 className='text-white md:px-36 px-5 text-xl md:text-2xl text-center 2xl:w-[60%]'>
							Transform the look of your interior with one of our popular
							interior services to make it look like-new!
						</h1>
						<Link
							href='/contact'
				...
				<div className='flex flex-col justify-center items-center mt-10'>
					<div className='flex flex-col gap-4 px-10 sm:w-1/2 sm:px-0 xl:w-1/3'>
						...
						<span>
							...
							Interior Cleaning: Covers every area from top to bottom and front
							to back, including seats, floor mats, door panels, dashboard,
							vents, and more.
						</span>
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Deep Shampoo
							Treatment: Includes full interior shampooing to lift dirt and
							grime.
						</span>
						<span>
						...
						<span id='options'>
							...
							Finish: Leaves your interior looking clean, smooth, and close to
							its original factory appearance—without any oily residue.
						</span>
					</div>
					<div className='flex flex-col md:flex-row items-stretch justify-center gap-10 w-full p-10'>
						<div className='md:w-1/2 lg:w-1/3 xl:1/4 2xl:w-1/5 border rounded-4xl flex flex-col justify-center items-center gap-5 p-10 relative hover:border hover:border-[#1589CF] transition-all hover:-translate-y-1'>
							...
							<span className='flex flex-col gap-2'>
								...
								<span>
									<FaCheck className='inline-block text-[#1589CF]' /> Wipe down
									of all dust and debris on all surfaces
								</span>
								<span>
						...
						<div className='md:w-1/2 lg:w-1/3 xl:1/4 2xl:w-1/5 border rounded-4xl flex flex-col justify-center items-center gap-5 p-10 relative hover:border hover:border-[#1589CF] transition-all hover:-translate-y-1'>
							...
							<span className='flex flex-col gap-2'>
								...
								<span>
									<FaCheck className='inline-block text-[#1589CF]' /> Clean
									rubber floor mats + shampoo carpet mats
								</span>
								<span>
								...
								<span>
									<FaCheck className='inline-block text-[#1589CF]' /> Apply a
									dust repellent to dash and door panels
								</span>
							</span>
							<a
								href='#cabin-care'
					...
					<div className='md:w-2/3 xl:w-1/3 w-fit border rounded-2xl p-10 m-10 flex flex-col justify-center items-center gap-10'>
						...
						<p className='sm:text-2xl text-xl -mx-5 sm:mx-0'>
							This is our <b>comprehensive deep cleaning service</b> that
							restores your vehicle's interior to like-new condition. It's ideal
							for cars that haven't been cleaned in a while or need more than
							just a surface touch-up.
						</p>
						<ul className='list-disc list-inside text-xl sm:w-4/5 -mx-4 -mb-5'>
							...
							<li className='mt-3 md:mt-2'>
								Shampoo and extraction of seats and floor mats to remove
						...
						<p
							id='quick-cabin-care'
							className='sm:text-2xl text-lg text-center'
						>
					...
					<div className='sm:w-2/3 xl:w-1/3 border rounded-2xl p-10 m-10 flex flex-col justify-center items-center gap-10'>
						...
						<p className='sm:text-2xl text-xl -mx-5 sm:mx-0'>
							This service is designed to keep your vehicle's interior fresh
							with regular upkeep. It <b>does not include deep cleaning</b> and
							is ideal for vehicles that are maintained regularly.
						</p>
						<ul className='list-disc list-inside text-xl sm:w-4/5 -mx-4 -mb-5'>
							<b>✅ What's Included:</b>
							<li className='mt-3 md:mt-2'>
						...
						<p className='sm:text-lg'>
							<b>Note:</b> For deep cleaning (carpet shampooing, seat
							extraction, door panel detailing, etc.), we recommend our{" "}
							<a
								className='underline hover:text-gray-400 transition-colors'
								href='#cabin-care'
							>
					...
					<div className='flex flex-col gap-4 px-10 sm:w-1/2 sm:px-0 xl:w-1/3'>
						...
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Clean spills
							or stains on carpets or fabric seats as soon as possible for the
							best chance of complete removal.
						</span>
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Promptly
							cleaning carpet stains helps prevent them from sinking deep into
							the fibers and causing lingering odors.
						</span>
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Schedule a
							full interior detail at least once a year to reset your vehicle's
						...
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> The
							Maintenance Program includes our exterior and interior service
							which is the{" "}
							<Link
