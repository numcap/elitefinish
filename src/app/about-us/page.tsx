	...
	return (
		<>
			...
			<div className='flex flex-col justify-center items-center gap-10'>
				...
				<p className='sm:w-1/2 sm:px-0 px-10 xl:w-1/3 text-xl'>
					Since I'm only one, we do our best to answer every call, text, and
					give all attention to our customers who are trusting us with their
					vehicle. We may take longer to answer sometimes but we will get back
				...
				<span className='sm:w-1/2 px-10 xl:w-1/3 mx-5 text-xl border rounded-4xl p-10'>
					...
					<p className='text-xl font-semibold text-center italic'>
						We want you to trust us with your vehicle to deliver the best
						results with an easy experience from start to finish.
					</p>
				</span>
				...
				<p className='sm:w-1/2 sm:px-0 px-10 xl:w-1/3 text-xl'>
					Whether the job is small or big, our mission is to deliver a
					hassle-free experience and at the same time, amazing cleaning.{" "}
				</p>
