			...
			<div>
				...
				<div className='flex flex-col justify-center items-center mt-10'>
					<div className='flex flex-col gap-4 px-10 sm:w-1/2 sm:px-0 xl:w-1/3'>
						...
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Paint
							Protection Application: Perfect for new vehicles or annual
							maintenance. We apply a protective ceramic layer to shield your
							paint from harsh weather.
						</span>
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Deep UV
							Defense: Protects against harmful sun rays that can cause fading,
							cracking, and clear coat damage over time.
						</span>
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Enhanced
							Appearance: Restores a deep, glossy shine to your vehicle, no
							matter if it's a 2010 model or a 2020 model.
						</span>
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Smooth Finish:
							After treatment, your paint will feel noticeably smoother,
							slicker, and better protected.
						</span>
						<span>
							<FaCheck className='inline-block text-[#1589CF]' /> Paint
							Longevity: Helps maintain the fresh, vibrant look of your
							vehicle's paint for years to come.
						</span>
						<span id='options'>
						...
						<div className='md:w-1/2 lg:w-1/3 xl:1/4 2xl:w-1/5 border rounded-4xl flex flex-col justify-center items-center gap-5 p-10 relative hover:border hover:border-[#1589CF] transition-all hover:-translate-y-1'>
							...
							<span className='flex flex-col gap-2'>
								...
								<span>
									...
									pre-rinse solution to chemically decompose, bugs, dirt, and
									bird droppings
								</span>
								<span>
								...
								<span>
									<FaCheck className='inline-block text-[#1589CF]' /> Dressing
									the fenders (if plastic) and tires to make them shine and
									touching up final details
								</span>
								<span>
									<FaCheck className='inline-block text-[#1589CF]' /> Cleaning
									the exterior windows to give you a streak free window
								</span>
							</span>
							<a
								href='#showroom-shine'
					...
					<div className='md:w-2/3 xl:w-1/3 w-fit border rounded-2xl p-10 m-10 flex flex-col justify-center items-center gap-10'>
						...
						<ul className='list-disc list-inside text-xl sm:w-4/5 -mx-4 -mb-5'>
							...
							<li className='mt-3 md:mt-2'>
								Pre-rinse solution applied to break down bird droppings and
								tough dirt
							</li>
					...
					<div className='flex flex-col gap-4 px-10 sm:w-1/2 sm:px-0 xl:w-1/3'>
						...
						<span>
							If you like a thorough cleaning on the interior of your vehicle
							for a complete transformation, then you can check out our{" "}
							<Link
							...
							<br /> This a great service to cleaning everything in your
							interior to the best condition possible.
						</span>
					</div>
				</div>
			</div>
