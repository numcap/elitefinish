...
export const metadata: Metadata = {
	title:
		"Elite Finish Auto | Mobile Car Detailing in London, Ontario",
	description:
		"Elite Finish Auto offers professional mobile car detailing services, (interior cleaning, exterior polishing, and paint correction) across London Ontario.",
	keywords: [
		"car detailing",
		"mobile detailing",
		"interior cleaning",
